      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-20 items-center">
        ...
        <FadeIn delay={0.1}>
          <div className="relative aspect-[3/4] overflow-hidden">
            {/* Replace with <Image> of real worship photography */}
            <div
              className="absolute inset-0"
              style={{
                background:
                  "linear-gradient(160deg, #1e1b14 0%, #2d2618 50%, #1a1612 100%)",
              }}
            />
            <div
              className="absolute inset-0 flex items-end p-8"
              style={{ background: "linear-gradient(to top, rgba(15,14,13,0.6) 0%, transparent 60%)" }}
            >
              <p
